...
<body>
	...
	<header>
		<div class="container">
			<h1><a href="dashboard.php">TokoSepatu</a></h1>
			<ul>
	...
	<div class="section">
		<div class="container">
			<h3>Data Produk</h3>
			<div class="box">
				<p><a href="tambah-produk.php" class="box-tambah">Tambah Data</a></p>
				<table border="1" cellspacing="0" class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="produk/<?php echo $row['product_img'] ?>" target="_blank"> <img src="produk/<?php echo $row['product_img'] ?>" width="50px"> </a></td>
